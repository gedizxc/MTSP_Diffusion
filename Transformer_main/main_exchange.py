...
parser.add_argument('--rev', type=bool, default=True, help='whether to apply RevIN')

#Diffusion
#Diffusion
parser.add_argument('--is_diffusion', type=int, default=0, help='use diffusion model')
...
parser.add_argument('--noise_step', type=int, default=32, help='diffusion noise step') #32
